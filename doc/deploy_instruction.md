...
You should see :
 ...
 <p align="center">
Press <kbd>9</kbd> to activate or deactivate the elastic band. When activated you can change the force of the elastic: <kbd>7</kbd> to raise, and <kbd>8</kbd>  to lower the robot.
</p>
